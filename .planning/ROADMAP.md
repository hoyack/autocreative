...
**Plans:** 8 plans
Plans:
- [ ] 18-01-PLAN.md -- Dependencies + errors + storage scaffold + `.brand-kit-template.json` + `.gitignore`
- [ ] 18-02-PLAN.md -- Pydantic v2 data models (BrandKit, BrandPalette, BrandTypography, BrandLogo, BrandVoice, BrandPhotoHints, ColorUsage)
- [ ] 18-03-PLAN.md -- Contrast module (wcag_ratio + AA/AAA classification + opposite-neutral swap + OKLCH remediation)
- [ ] 18-04-PLAN.md -- Scraper (Playwright primary + httpx/BS4/tinycss2 fallback + SSRF gating + palette extraction)
- [ ] 18-05-PLAN.md -- Applier (apply_brand_kit immutable transform with palette/typography swap + size_multiplier scaling + AA guardrail)
...
| 18. Brand Kit System | 0/8 | Not Started | - |
