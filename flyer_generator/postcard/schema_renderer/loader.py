"""Postcard template schema loader — reads JSON, validates via Pydantic."""
...
def load_template(name_or_path: str) -> PostcardTemplateSchema:
    """Load a postcard template schema by name (looks under schemas/) or file path.

    Raises:
        FileNotFoundError: No matching file found.
        pydantic.ValidationError: JSON doesn't match PostcardTemplateSchema.
    """
    ...
    return PostcardTemplateSchema.model_validate(raw)
